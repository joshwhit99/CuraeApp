...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="Curae.Azure" generation="1" functional="0" release="0" Id="550dba5b-c241-41fd-a694-4c32bbfe0469" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="Curae.AzureGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="Curae" generation="1" functional="0" release="0" software="C:\Users\akasht\Desktop\CuraeAnalytics\Curae\Curae.Azure\csx\Debug\roles\Curae" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="2f0e413c-b694-452f-aacc-58fa70ed606b" ref="Microsoft.RedDog.Contract\ServiceContract\Curae.AzureContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="594c703a-abb9-475b-9a7d-24181392edd4" ref="Microsoft.RedDog.Contract\Interface\Curae:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Curae.Azure/Curae.AzureGroup/Curae:Endpoint1" />
          </inPort>
        </interfaceReference>
